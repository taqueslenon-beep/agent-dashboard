...
def get_agents():
    return {
        "gabinete-ceo": [
            {"id": "secretaria-executiva", "name": "Secretária Executiva", "role": "Despacho de Trello e Triagem de Notificações", "description": "Processa notificações do Trello, enriquece contexto com 7 fontes externas, sugere respostas e ações, e documenta no Obsidian. HITL obrigatório.", "tags": ["Trello", "Gmail", "Calendar", "Todoist", "WhatsApp", "Slack", "Drive", "Supabase", "Obsidian", "HITL"], "status": "prototype", "icon": "🗂", "department": "gabinete-ceo", "level": 1},
        ...
        "inteligencia": [
            {"id": "monitor-legislativo", "name": "Monitor Legislativo", "role": "Monitoramento de Leis, Resoluções e Portarias", "description": "Monitora publicações legislativas relevantes para direito ambiental.", "tags": ["Legislação", "CONAMA", "IBAMA", "Direito Ambiental"], "status": "planned", "icon": "📜", "department": "inteligencia", "level": 0},
            {"id": "monitor-jurisprudencial", "name": "Monitor Jurisprudencial", "role": "Monitoramento de Decisões dos Tribunais", "description": "Acompanha decisões de tribunais superiores e TJs em matéria ambiental.", "tags": ["Jurisprudência", "STJ", "STF", "TRF4", "TJSC"], "status": "planned", "icon": "⚖️", "department": "inteligencia", "level": 0},
            {"id": "monitor-geoambiental", "name": "Monitor Geoambiental", "role": "Monitoramento de MapBiomas, DETER e CAR", "description": "Monitora alertas de desmatamento, mudanças no MapBiomas e atualizações do CAR/SICAR.", "tags": ["MapBiomas", "DETER", "CAR", "SICAR", "Geoprocessamento"], "status": "planned", "icon": "🗺️", "department": "inteligencia", "level": 0},
            {"id": "monitor-juridico", "name": "Monitor Jurídico", "role": "Monitoramento de Sites Jurídicos Especializados", "description": "Acompanha publicações em sites jurídicos especializados.", "tags": ["Notícias", "Doutrina", "Artigos Jurídicos"], "status": "planned", "icon": "📰", "department": "inteligencia", "level": 0},
            {"id": "monitor-concorrencia", "name": "Monitor de Concorrência", "role": "Monitoramento de Posicionamento de Concorrentes", "description": "Monitora atuação de escritórios concorrentes em direito ambiental.", "tags": ["Concorrência", "Mercado", "Benchmarking"], "status": "planned", "icon": "🎯", "department": "inteligencia", "level": 0},
            {"id": "monitor-tendencias", "name": "Monitor de Tendências", "role": "Monitoramento de Tendências de Mercado", "description": "Identifica tendências emergentes no mercado jurídico ambiental.", "tags": ["Tendências", "Mercado", "Oportunidades"], "status": "planned", "icon": "📈", "department": "inteligencia", "level": 0},
        ],
    }
...
def get_automations():
    return [
        ...
        {"id": "verificador-compromissos", "name": "Verificador de Compromissos Pessoais", "type_label": "Automação · Cron · WhatsApp + GCal", "description": "Verifica compromissos pessoais recorrentes (terapia, barbearia) via WhatsApp e Google Calendar. Confirma se mensagens de confirmação foram enviadas e reporta ao painel.", "tags": ["WhatsApp", "Google Calendar", "Todoist", "Pessoal", "6h"], "status": "active", "icon": "🔍", "trigger_type": "cron", "trigger_config": {"cron": "0 6 * * *", "compromissos": [{"tipo": "terapia", "contato": "Bruna de Oliveira", "jid": "554188887092@s.whatsapp.net"}, {"tipo": "corte-cabelo", "contato": "Bravos Barbearia", "jid": "554797035509@s.whatsapp.net"}]}},
        ...
        {"id": "padronizador-agenda", "name": "Padronizador de Agenda Google Calendar", "type_label": "Automação · Cron · Google Calendar + Supabase", "description": "Padroniza títulos de todos os eventos da semana corrente no Google Calendar seguindo o guia documentado no Obsidian. Aplica emojis, separadores, prefixo PRÉ-AGENDADO e tom de pele. Roda diariamente à meia-noite (BRT).", "tags": ["Google Calendar", "Supabase", "Padronização", "Cron", "00h"], "status": "active", "icon": "📅", "agent_id": "padronizador-agenda", "trigger_type": "cron", "trigger_config": {"cron": "0 3 * * *", "trigger_id": "trig_013KWNDLYq9CznGdKcA2kRJQ", "endpoint": "RemoteTrigger (CCR)"}},
    ]
